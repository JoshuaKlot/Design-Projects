...
int find_min_cost(Block *blocks, int num_blocks, int index, Row row1, Row row2, 
    ...
    if (dp[index][row1_length][row2_length] != INT_MAX) return dp[index][row1_length][row2_length];
